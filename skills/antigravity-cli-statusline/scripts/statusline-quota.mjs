...
function buildI18nDict(lang, m) {
  const dicts = {
    'zh-tw': {
      ...
      'quota': `${WHITE}可用額度:${RESET} ${m.quotaColor}${BOLD}${m.quotaVal}${RESET}`,
      'context-used': `${WHITE}上下文:${RESET} ${m.contextColor}${BOLD}${m.usedPct}${RESET}`,
      'memory-usage': `${WHITE}記憶體:${RESET} ${BLUE}${BOLD}${m.memUsage}${RESET}`,
      'token-count': `${WHITE}權杖數:${RESET} ${m.tokenCount}`,
      'quota-reset-countdown': `${WHITE}重置倒數:${RESET} ${BLUE}${BOLD}${m.countdownVal}${RESET}`,
      'quota-weekly': `${WHITE}每週額度:${RESET} ${m.weeklyQuotaColor}${BOLD}${m.weeklyQuotaVal}${RESET}`,
      'quota-weekly-countdown': `${WHITE}每週重置:${RESET} ${BLUE}${BOLD}${m.weeklyCountdownVal}${RESET}`,
    ...
    'jp': {
      ...
      'quota': `${WHITE}API可用額度:${RESET} ${m.quotaColor}${BOLD}${m.quotaVal}${RESET}`,
      ...
      'quota-reset-countdown': `${WHITE}リセットまで:${RESET} ${BLUE}${BOLD}${m.countdownVal}${RESET}`,
      'quota-weekly': `${WHITE}週間可用額度:${RESET} ${m.weeklyQuotaColor}${BOLD}${m.weeklyQuotaVal}${RESET}`,
